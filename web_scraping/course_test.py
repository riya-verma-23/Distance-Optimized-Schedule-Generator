...
class TestWebScraping(unittest.TestCase):
  ...
  def test_linked_term(self):
    ...
    # cs222 is the course used for comparison because (1) it has one section, which
